...
There is also a[ Mac toolbar app](https://github.com/hfactor/cinema-radio-mac-menubar) that connects to the same system, so you can tune in without opening a browser. If you want to add a new band or contribute films to an existing one, you can do that directly through the library files, which is how the catalogue has been growing.
