...
The same logic is behind [[Stop spending time on wireframing]] and [[Fat-marker method]]: low fidelity isn't a limitation, it's protection against premature attachment to a specific solution. The canvas becomes the right tool once the work needs spatial judgment, when layout, type, and visual weight are the actual decision. Until then, opening a design file is often the wrong starting point.
